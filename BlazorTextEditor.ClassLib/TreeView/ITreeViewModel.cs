namespace BlazorTextEditor.ClassLib.TreeView;
...
{
    public TreeViewModel(TItem item, Func<TreeViewModel<TItem>> loadChildrenFuncAsync)
    {
        Item = item;
    ...
    public Func<TreeViewModel<TItem>> LoadChildrenFuncAsync { get; set; }
